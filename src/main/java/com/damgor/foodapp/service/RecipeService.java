...
public interface RecipeService {
    ...
    List<ShortRecipe> getRecipesByIngredients(String ingredients, long userId, int number);
    List<ShortRecipe> getRecipesByText(String text, long userId, int number, int offset);
